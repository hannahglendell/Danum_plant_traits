...
#before going any further, save this file as a .csv, so that it can be used to calculate relative abundance.
...
# Step 1: Bind the two dataframes
...
INDFORSUS_species_list <- INDFORSUS_data %>%
  ...
  rename( #change the names of the columns so that they are written with capital letters
    ...
    Species = species)
#
#remove all rows where species_origin = 50ha, so that I am not duplicating information
